...
Dans ce mini-hack, il s'agit de mettre en place un service capable d'envoyer un mail de notification lorsque qu'un nouvelle branche est créée au sein d'un projet Platform.sh.
